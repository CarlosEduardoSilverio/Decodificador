...
function criptografar() {
    ...
    document.getElementById("saida").innerHTML = '<textarea class="Texto-Resultado" id="TextoResultado">' + resultCripto + 
    '</textarea>'
}
...
function descriptografar() {
    ...
    document.getElementById("saida").innerHTML ='<textarea class="Texto-Resultado" id="TextoResultado">' + DescriptografarTexto + 
    '</textarea>'
}
